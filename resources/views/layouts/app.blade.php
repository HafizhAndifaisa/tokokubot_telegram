...
<head>
    ...
    <!-- Datepicker -->
    <link href="{{ asset('vendor/bootstrap-datepicker/css/datepicker.min.css') }}" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="{{route('home')}}" style="font-family:'Tokoku'">Noor Electric</a>
        ...
        <div class="row">
            ...
            <div class="sidebar-sticky">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{Request::segment(1) == 'laporanexcel' ? 'active':''}}" href="{{route('lapIndex')}}"><span class="fa fa-file-excel fa-fw"></span> Cetak Laporan</a>
                    </li>
                </ul>
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{Request::is('warehouse/create')  ? 'active':''}}" href=""><span class="fa fa-plus-square fa-fw"></span> Gudang Baru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{Request::is('warehouse') ? 'active':''}}" href=""><span class="fa fa-map-marker-alt fa-fw"></span> List Gudang</a>
                    </li>
                </ul> -->
                ...
                <!-- <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{Request::segment(1) == 'periode' ? 'active':''}}" href=""><span class="fa fa-calendar-alt fa-fw"></span> Periode</a>
                    </li>
                </ul> -->
...
<!-- Datepicker -->
<script src="{{ asset('vendor/bootstrap-datepicker/js/datepicker.min.js') }}"></script>
