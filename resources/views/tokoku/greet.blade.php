...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="container">
        <h1 class="mt-5">Selamat Datang di <span style="font-family:'Tokoku'">Noor Electric</span></h1>
        ...
        <div class="row">
            ...
            <!-- <div class="col-md-4">
                ...
                <p><a class="btn btn-info" href="" role="button"><span class="fa fa-map-marker-alt"></span> Tambah</a></p>
            </div> -->
            <div class="col-md-4">
                <h3>Stok Opname</h3>
