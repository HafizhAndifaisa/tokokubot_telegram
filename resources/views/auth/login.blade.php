...
<head>
    ...
    <link href="{{ asset('css/custom/signin.css') }}" rel="stylesheet">
</head>
<body class="text-center">
    <form class="form-signin" method="POST" action="{{ url('/login') }}" autocomplete="off">
        {{ csrf_field() }}
        <h1 class="h3 mb-3 font-weight-normal" style="font-family:'Tokoku'; color:cornsilk">Manajemen Toko Noor Electric</h1>
